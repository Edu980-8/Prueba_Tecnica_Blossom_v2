    ...
    <div className="px-6">
      <div className="grid grid-cols-[23%_70%] gap-[5%]">
        ...
        <div className="mt-6">
          ...
          <div className="w-full bg-gray-200 p-3 flex items-center gray-200 rounded-[8px]">
